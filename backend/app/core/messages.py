...
_EXACT_TRANSLATIONS: Final[dict[str, str]] = {
    ...
    "Invalid or expired verification token": "لینک تأیید نامعتبر یا منقضی شده است",
    "Too many verification requests. Please try again later.": "تعداد درخواست‌های تأیید زیاد است. لطفا بعدا دوباره تلاش کنید.",
    "Invalid verification kind": "نوع تأیید نامعتبر است",
